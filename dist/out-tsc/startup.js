...
var user_resolver_1 = require("./application/resolvers/user.resolver");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var schema, server, serverOptions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    schema = _a.sent();
                    server = new graphql_yoga_1.GraphQLServer({ schema: schema });
                    serverOptions = {
                        port: 4000,
                        endpoint: "/graphql",
                    ...
                    // Start the server
                    server.start(serverOptions, function (_a) {
                        var port = _a.port, playground = _a.playground;
